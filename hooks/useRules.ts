...
import { RULES_STORAGE_KEY } from '@/config/constants';
import type { Rule } from '@/types/transaction';

/**
 * Regras de categorização automática por palavra-chave. Persistidas em
 * localStorage, mesma estratégia usada em hooks/useCategories.ts.
 */
